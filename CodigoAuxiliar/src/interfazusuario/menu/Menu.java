...
/**
 * Clase que implementa un menú en pantalla.
 ...
 * Si se desea se puede indicar que utilice las letras del abecedario.
 * 
...
public class Menu {//Menu
	...
	/**
	 * Atributo que indica c�mo se han de numerar las opciones y que indica cuál es el tipo
	...
	/**
	 * Constructor que recibe sólo las opciones. Las opciones se numerarón utilizando números
	 * @param opciones es el vector de cadenas de caracteres que se utilizará en el menú
	 */
	 ...
	 * @return String  con la opción seleccionada. Si el modo es número ver Numerar.NUMERO el valor 
